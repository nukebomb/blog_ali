...
code ./
```
<img src="../../public/images/hexo_needed/first.png">
...
hexo generate
```
<img src="../../public/images/hexo_needed/初始化.png">
...
```
启动预览
<img src="../../public/images/hexo_needed/启动.png">

打开浏览器，在http://localhost:4000/就可以看到生成页面的效果
<img src="../../public/images/hexo_needed/初始页面.png">
...
<img src="../../public/images/hexo_needed/链接成功.png">
...
<img src="../../public/images/hexo_needed/成功部署静态.png">
...
<img src="../../public/images/hexo_needed/xftp.png">

<img src="../../public/images/hexo_needed/文件传输.png">
...
<img src="../../public/images/hexo_needed/域名访问.png">
...
<img src="../../public/images/hexo_needed/添加openssh.png">
<img src="../../public/images/hexo_needed/添加openssh1.png">
...
ssh-keygen -t rsa
```
<img src="../../public/images/hexo_needed/秘钥对生成.jpg">
...
```
结果如图
<img src="../../public/images/hexo_needed/测试结果.png">
...
```
<img src="../../public/images/hexo_needed/本地克隆.png">
...
在最下面deploy位置修改如下
<img src="../../public/images/hexo_needed/修改deploy.png">
...
<img src="../../public/images/hexo_needed/json-script.png">
...
<img src="../../public/images/hexo_needed/预览测试md.png">
插件自带 snippet，支持LATEX数学公式
<img src="../../public/images/hexo_needed/latex.png">
...
<img src="../../public/images/hexo_needed/七牛-bucket.png">
<img src="../../public/images/hexo_needed/七牛-bucket-2.png">


配置完成，在 image-helper 选择七牛云，然后就会把图片上传到你的七牛云并返回链接插入到 markdown 中。

<img src="../../public/images/hexo_needed/七牛云配置.png">
<img src="../../public/images/hexo_needed/七牛云2.png">
